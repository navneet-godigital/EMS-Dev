                ...
                <div className="container">
                    <div className="row">
                        <div className="section-title2 text-center">
                            <h3>Basic Requirements for  Starting Your Own NTT Nursery Teacher Training training institute /Training Center Franchise Registration Basic requirements Detail are:</h3>
                        </div>
                        <div className="section-title3 ">
                            <h4>Basic Requirements for take franchise for Computer center Institute Franchise Registration Open:</h4>
                        </div>
                        ...
                        <div className="Apply1">
                            <a href="default.asp" target="_blank" className='Apply'>Apply Now For Admission </a>
                            <a href="default.asp" target="_blank" className='Apply' >Apply now for Franchise </a>
                        </div>
                        <div className="section-title2">
                        ...
                        <div className="section-title2">
                            ...
                            <p><span>1. </span>What is your company about? </p>
                            <p><span>2.</span>What are your core values?</p>
                            <p><span>3.</span>What are your core values?</p>
                        </div>
                        <div className="about-cont1">
                            <h3>Starting a Computer Training Center/Step For take franchise for Computer Institute Registration:</h3>
                        </div>
                        <div className="section-title2">
                        ...
                        <div className="section-title2">
                            <p><span>What is the scope of computer Center in India?</span></p>
                            <p>The main aim of computer course you can apply in all those jobs For Pvt. Job & Govt. Job & Self  Employment.</p>
                        </div>
                    </div>
                </div>
            </div>
