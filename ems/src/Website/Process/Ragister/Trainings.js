                ...
                <div className="container">
                    <div className="row">
                        <div className="section-title2">
                            <p><span>List of NTT Teacher Training Colleges in India | Top 10 Nursery Teacher Training (NTT)  Course Institute in India</span></p>
                        </div>
                        <div className="section-title2">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">how to register NTT Franchise in India |  NTT Course | NTT Center Recognition open Start in India franchise for ntt NTT Center List In India Center Name</th>
                            ...
                            <tbody>
                                <tr>
                                    <th scope="row">1</th>
                                    <td>
                                        <img src="../img/logo-3.png" width="40" height="40" alt="" />
                                    </td>
                                    <td>
                                        <img src="../img/logo-3.png" width="40" height="40" alt="" />
                                    </td>
                                    <td>ZEB COMPUTER INSTITUTE ( Jeevan Appt 2, Vaishali Nagar, Nagpur-17, M.H Code EMAX/EK44998)</td>
                                    <td>EMAX/EK44998</td>
                                </tr>
                                <tr>
                                    <th scope="row">2</th>
