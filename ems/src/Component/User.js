            ...
            <Sidebar>
                ...
                <div className="m-2">
                    <div className='list mb-4'>
                        ...
                        <h5 class="d-inline" style={{ color: "#A09E9D", fontSize: '20px' }}>Manage User</h5>
                    </div >

                    <div id="exTab3">
                        <ul class="nav nav-pills">
                            <li class="active">
                                <a href="#1b" data-toggle="tab"><AiOutlineMenu />{" "}User List</a>
                            </li>
                            <li><a href="#2b" data-toggle="tab"><FaPlus />{" "}Add User</a></li>
                        </ul>
                        ...
                        <div class="tab-content clearfix">
                            ...
                            <div class="tab-pane" id="2b"><AddUser /></div>
                        </div>
                    </div>
                </div>
            </Sidebar>
